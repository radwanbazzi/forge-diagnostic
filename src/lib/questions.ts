...
export const Q10_OPTIONS = ['A) library, only', 'B) library; only', 'C) library only', 'D) library: only'] as const;
...
export const QUESTIONS: readonly Question[] = [
	...
	{ n: 5, field: 'q5', section: 2, kind: 'choice', required: true, prompt: "A phone plan charges a flat $12/month plus $0.05 per text. One month's bill was $27. How many texts were sent?", options: Q5_OPTIONS },
	{ n: 6, field: 'q6', section: 2, kind: 'choice', required: true, prompt: 'Solar panel efficiency has improved steadily over the past decade. ____, the cost per watt has fallen by more than 80%, making home installation affordable for many families.', options: Q6_OPTIONS },
	{ n: 7, field: 'q7', section: 2, kind: 'choice', required: true, prompt: 'The function f(x) = 2x² − 8x + 6 crosses the x-axis at two points. What is the sum of those x-coordinates?', options: Q7_OPTIONS },
	{ n: 8, field: 'q8', section: 2, kind: 'choice', required: true, prompt: '…she is unsparing about her own early missteps, recounting them with a candor that borders on ____; she seems almost eager to expose the naïveté of her younger self.', options: Q8_OPTIONS },
	{ n: 9, field: 'q9', section: 2, kind: 'choice', required: true, prompt: "A jacket's price is raised 20%, then later marked 20% off the increased price. The final price is what percent of the original?", options: Q9_OPTIONS },
	{ n: 10, field: 'q10', section: 2, kind: 'choice', required: true, prompt: 'The committee reviewed three proposals for the new library ____ only one, however, met the budget requirements.', options: Q10_OPTIONS },
	{ n: 11, field: 'q11', section: 2, kind: 'choice', required: true, prompt: 'In right triangle ABC (right angle at C), sin(A) = 3/5 and hypotenuse AB = 20. Length of the side opposite angle A?', options: Q11_OPTIONS },
	{ n: 12, field: 'q12', section: 2, kind: 'choice', required: true, prompt: 'No cooking hearths were found inside the walls, though surrounding fields showed abundant grain farming, and storage pits were unusually large. Best-supported conclusion?', options: Q12_OPTIONS },
